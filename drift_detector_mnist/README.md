...
```bash
$ python -m drift_detector_mnist.make_dataset {your_arguments}
$ python -m drift_detector_mnist.make_model {your_arguments}
$ python -m drift_detector_mnist.compare_models {your_arguments}
```
...
```bash
$ python -m drift_detector_mnist.dataset.make_dataset {your_arguments}
$ python -m drift_detector_mnist.models.make_model {your_arguments}
$ python -m drift_detector_mnist.visualization.compare_models {your_arguments}
```
