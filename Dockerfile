...
LABEL version='0.0.1'
# Drift Detector for MNIST images with Frouros
...
# Install user app
RUN git clone -b $branch --depth 1 https://github.com/ai4os-hub/drift-detector-mnist && \
    pip3 install --no-cache-dir -e ./drift-detector-mnist
